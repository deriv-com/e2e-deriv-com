...
describe('QATEST-1328 - Live Pricing table EU', () => {
  ...
  it('should click on View All link on all the 6 markets and check whether all instruments for the particular market is displayed - EU desktop.', () => {
  ...
  it('should click on View All link on all the 6 markets and check whether all instruments for the particular market is displayed - EU mobile.', () => {
