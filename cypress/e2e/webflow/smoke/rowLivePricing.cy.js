...
describe('QATEST-1320 - Live Pricing table ROW', () => {
  ...
  it(
    'should click on View All link on all the 6 markets and check whether all instruments for the particular market is displayed - ROW desktop.',
    { tags: ['@smoke-tests', '@row-tests'] },
    () => {
  ...
  it(
    'should click on View All link on all the 5 markets and check whether all instruments for the particular market is displayed - ROW mobile.',
    { tags: ['@smoke-tests', '@row-tests'] },
    () => {
