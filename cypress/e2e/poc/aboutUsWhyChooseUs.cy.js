...
describe('QATEST-1647 - should validate the About Us - Why choose us', () => 
{
    ...
    it('should validate Why Choose Us page for EU', () => {
        cy.c_visitResponsive(`/why-choose-us/${Cypress.env('RegionEU')}`, 'desktop', 'quickload')
        cy.wait(15000) //Temporary until the WhatsApp link gets fixed.

        validate_AboutUs_whyChooseUs()
    })

    // it('should validate Why Choose Us page for ROW', () => {
    //     cy.c_visitResponsive(`/why-choose-us/${Cypress.env('RegionROW')}`, 'desktop', 'quickload')
