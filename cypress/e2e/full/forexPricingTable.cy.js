...
describe('QATEST1320 - Validating the updates of pricing table - ROW & EU', () => {
  it(
    'should navigate to forex pricing table and check whether the values are getting updated - ROW.',
  ...
  it(
    'should navigate to forex pricing table and check whether the values are getting updated - EU.',
