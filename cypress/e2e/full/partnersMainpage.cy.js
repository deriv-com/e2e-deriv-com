...
function Partner_page(region) {
    ...
    cy.findByRole('heading', { name: 'Deriv partnership programmes', exact: true }).should('be.visible')
    ...
    const urlDetails = region === 'EU' ? [
        ...
        }, 
        {
            ...
            title:'Affiliate and IB programmes | Partnership programmes | Deriv',
