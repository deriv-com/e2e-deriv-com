...
function validate_dtraderpage(region) {
  ...
  cy.findByRole('img', { name: 'Place a trade' })
    .scrollIntoView()
    .should('be.visible', { timeout: 50000 })
  ...
  for (let index = 0; index < 2; index++) {
    cy.findAllByRole('link', { name: 'Go to live demo' }, { timeout: 10000 })
      .eq(index)
...
describe('QATEST-1529 - should validate the dtrader page in desktop', () => {
  it(
    'should be able to navigate to dtrader page from home page and validate the page content and links for EU',
  ...
  it(
    'should be able to navigate to dtrader page from home page and validate the page content and links for ROW',
