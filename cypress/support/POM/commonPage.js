...
//       }
//       rowFooterPdfs = {
//         dfxLicencePdf: '/regulatory/Deriv_(FX)_Ltd.pdf',
//         bviLicencePdf: '/regulatory/Deriv_(BVI)_Ltd.pdf',
//         vanuatuLicencePdf: '/regulatory/Deriv_(V)_Ltd.pdf',
//         rowRiskDisclosurePdf: '/tnc/risk-disclosure.pdf',
//       }
// }
...
class footer {
  elements = {
    termsAndConditionLink: () => cy.findByRole('link', { name: 'Terms and conditions' }),
    secureAndRespTradingLink: () =>
      cy.findByRole('link', { name: 'Secure and responsible trading' }),
    riskDisclosureLink: () => 
      cy.findByRole('link', { name: 'Risk disclosure' }),
    dfxLicenceLink: () => 
      cy.findAllByRole('link', { name: 'licence' }).eq(0),
    bviLicenceLink: () => 
      cy.findAllByRole('link', { name: 'licence' }).eq(1),
    vanuatuLicenceLink: () => 
      cy.findAllByRole('link', { name: 'licence' }).eq(2),
    dielLicenceLink: () => 
      cy.findByRole('link', { name: 'licence' }),
  }
